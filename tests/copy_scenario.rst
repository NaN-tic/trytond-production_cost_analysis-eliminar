...
Install production Module::
    ...
    >>> config = activate_modules('production_cost_analysis')
...
Check Analysis Creation Real and deviation movements::

    >>> analysis = production.production_cost_analysis
    >>> len(analysis.real_inputs_costs)
    2
