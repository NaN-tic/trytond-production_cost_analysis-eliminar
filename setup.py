...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-production_cost_analysis',
    download_url='https://github.com:nantic/trytond-production_cost_analysis.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-production_cost_analysis.git'
    },
    classifiers=[
